...
def getimage_num(numero):
    ...
    draw.text((190, 90), str(numero), font=fuente, fill="black")
...
def getimage_2(bundle):
    ...
    if part_dec == 0:
        ...
        # print "caso 3"
        # If sqrt is less than 0.5 -> Only needed to add 1 to rows
        #  (the col won't get filled)
        columnas = part_ent
        filas = columnas + 1
    a = filas
    filas = columnas
    ...
    # Get the ratio, to get the width of the final image,
    # based on any image of array.
